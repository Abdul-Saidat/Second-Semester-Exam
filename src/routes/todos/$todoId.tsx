...
export const Route = createFileRoute("/todos/$todoId")({
  ...
  const okCurrentPage = o.currentPage === undefined || typeof o.currentPage === "number";
  const okCheckedTodos = o.checkedTodos === undefined || Array.isArray(o.checkedTodos);
...
function TodoDetailPage() {
  ...
  const { isPending, error, data } = useQuery<Todo, Error>({
...
const linkState = isLocationState(linkStateRaw) ? (linkStateRaw as LocationState) : undefined;

  const isChecked = data ? checkedTodos.includes(data.id) : false;
